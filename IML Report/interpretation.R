...
bob <- bob[!(names(x) %in% exclude)] # the re-execute the code above
james <- james[!(names(x) %in% exclude)] # the re-execute the code above
data <- data[!(names(data) %in% exclude)] # the re-execute the code above
