...
After a few minutes of googling, he finds the very well known south german credit data set. As he doesn't have the bank's machine learning model, he fits his own model on the data set. His model performs really well on test data, which reassures him that it can be used in place of the bank's model. He also applies the model on his self, as he has been thinking about moving out of their current appartment and buying a house soon for him and his wife. The model predicts a `bad` credit_risk. Now all that's left to do is for him to understand the model using IML methods and then look into his and his friends case. 

In order to do so, he divides the problem in to two. First, he wants to get a general understanding of the model and verify that it's predictions make sense. Seconds, he would investigate, much like a detective, his and his friend's case.
