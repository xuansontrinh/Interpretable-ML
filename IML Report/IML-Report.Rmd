...
The code snippet below shows the tuning setup for Xgboost and the radial basis kernel SVM. Please refer to the code in `source code.R` for the other models tuning configurations.
```{r, eval=FALSE}
# xgboost
...
|What can Bob do to improve his credit, i.e. to be considered `good` (according to this model's point of view)?|Counterfactual Explanations|
...
=======
5. What can Bob do to improve his credit, i.e. to be considered `good` (according to this model)? \
...
>>>>>>> 68b5c93fb396c822c0e8e31291fd53cd7a4be664
